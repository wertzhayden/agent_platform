...
from webscraper.views.ourlads.college_depth_chart import IngestOurladsDepthCharts
...
from webscraper.views.ourlads.nfl_active_players import IngestActiveNFLPlayersBySchool
